...
# %%
maxes = [[10, 100], [20, 200], [50, 500], [90, 900]]
titles = [60, 70, 80, 90]
fig, axf = plt.subplots(ncols=2, nrows=4, figsize=(6, 4))
...
fig.savefig(r"projects\Dissertation\dissertation\figures\external_mic_ratio.pdf", dpi=300)
# %%
channels = [0, 1, 2, 3, 7]
data = []
for r, record in enumerate(records):
