...
for f, filt in enumerate(filts):
    ...
    for i, t in enumerate(targets):
        ...
        fig.savefig(f"projects/Dissertation/proposal/figures/normalization/{t['target']}_{t['material']}_waveform_normalized ({filt[0]}-{filt[1]}).pdf", dpi=300)

        # change fig size to (6, 1.5)
