...
for i, t in enumerate(targets):
    ...
    audio = normalization.noise_normalize(db, audio, channel=channel, filter="bandpass", low=500, high=6000, coefficient="set")
    ...
    fig.savefig(
        f"projects/Dissertation/proposal/figures/nspa_nsel/{t['target']}_{t['material']}_nspa.pdf",
        dpi=300,
    )
# %%
