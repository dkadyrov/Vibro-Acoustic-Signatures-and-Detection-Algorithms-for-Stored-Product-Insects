...
ax.set_xlabel("Time [s]")
fig.savefig(
    r"projects\Dissertation\dissertation\figures\5_11b_external_noise_algorithm_90_combined.pdf",
    bbox_inches="tight",
    dpi=300,
)
...
ax.legend(loc="upper right", handlelength=0, handletextpad=0, markerscale=0)
fig.savefig(
    r"projects\Dissertation\dissertation\figures\5_11c_external_noise_algorithm_90_combined_cleaned.pdf",
    bbox_inches="tight",
    dpi=300,
)
# %%
