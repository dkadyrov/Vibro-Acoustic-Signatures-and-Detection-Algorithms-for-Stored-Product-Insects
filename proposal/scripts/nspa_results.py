...
cbar.set_label(label='NSPA Difference [dB]', size=9)
...
#%%
fig, ax = plt.subplots()
ax.scatter(values["low"], values["nspa"], c="black", s=15)
...
ax.scatter(convergence["frequency"], convergence["nspa_diff"], color="red", s=10, zorder=3)
