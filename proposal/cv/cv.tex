...
\begin{itemize}
  \item D. Kadyrov, A. Sutin, N. Sedunov, A. Sedunov, and H. Salloum, ``Vibro-Acoustic Signatures of Various Insects in Stored Products,'' Sensors, vol. 24, no. 20, Art. no. 20, Jan. 2024
  \item D. Kadyrov, A. Sedunov, N. Sedunov, A. Sutin, H. Salloum, and S. Tsyuryupa, ``Improvements to the Stevens Drone Acoustic Detection System,'' Proc. Mtgs. Acoust., vol. 46, no. 1, p. 045001, May 2022
\end{itemize}

\section*{Conferences}
\begin{itemize}
  \item DHS Research Development \& Testing and Evaluation Summit (Online, 2024)\\
  \textit{Stored Product Insect Detection Systems (SPIDS)}
  \item Artificial Intelligence Meets Science (AIMS) Conference (New York, 2023)\\
  ...
  \textit{D. Kadyrov, A. Sedunov, N. Sedunov, A. Sutin, H. Salloum, and S. Tsyuryupa, ``Improvements to the Stevens Drone Acoustic Detection System,'' Proc. Mtgs. Acoust., vol. 46, no. 1, p. 045001, May 2022}
\end{itemize}
\end{singlespace}
